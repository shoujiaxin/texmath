...
class SymbolViewController: ViewControllerBase {
    override func viewDidLoad() {
        ...
        items.sections[0].addItem(withName: "Subset", imageName: "SubsetButtonIcon", latexCode: "\\subset ")
        items.sections[0].addItem(withName: "Subset or Equal", imageName: "SubsetEqualButtonIcon", latexCode: "\\subseteq ")
        items.sections[0].addItem(withName: "Superset", imageName: "SupersetButtonIcon", latexCode: "\\supset ")
        items.sections[0].addItem(withName: "Superset or Equal", imageName: "SupersetEqualButtonIcon", latexCode: "\\supseteq ")
        items.sections[0].addItem(withName: "Square Subset", imageName: "SqsubsetButtonIcon", latexCode: "\\sqsubset ")
        items.sections[0].addItem(withName: "Square Subset or Equal", imageName: "SqsubsetEqualButtonIcon", latexCode: "\\sqsubseteq ")
        items.sections[0].addItem(withName: "Square Superset", imageName: "SqsupersetButtonIcon", latexCode: "\\sqsupset ")
        items.sections[0].addItem(withName: "Square Superset or Equal", imageName: "SqsupersetEqualButtonIcon", latexCode: "\\sqsupseteq ")
